...
namespace DownloadManager.ViewModels
{
    class DownloadViewModel : INotifyPropertyChanged, IObservable<File>
    {
        ...
        private List<IObserver<File>> observers = new List<IObserver<File>>();
        ...
        private void _webClient_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            _newFile = new File()
            {
                ...
                FileSize = (String.Format("{0:0.##} MB", this._fileSize / 1048576)),
            ...
            _homeViewModel.FilesList.Add(_newFile);
            HomeView home = new HomeView(_homeViewModel);
